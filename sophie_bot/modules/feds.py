...
async def fed_ban_user(message, fed, user, reason, strings):
    ...
    if user_id in OPERATORS:
        ...
        await message.reply("Sorry I failed to do it. Anon admins not yet supported directly. Use connection")
        return       
...
async def fban_export(message, fed, strings):
    ...
    try:
        ...
        return await message.reply("Sorry I accounted an error and failed to do that")
    try:
        redis.set(key, 1)
